 ...
 * 
 */
public class DImagenTraslacion extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(TX, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0;i<imagen.length;i++){
          ...
          punto.dibujo(g);
           ...
           for (int i = 0;i<imagen.length;i++) {
           imagen [i][0] = imagen [i][0]  + tx;
           imagen [i][1] = imagen [i][1]  + ty;
      }
      for (int i = 0;i<imagen.length;i++){
          x = imagen [i][0];
          y = imagen [i][1];
...
;        int a = 0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DImagenTraslacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DImagenTraslacion().setVisible(true);
            }
        });
    }
